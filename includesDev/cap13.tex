...
To be able to send API requests, you need to get a session token using GET to url \murl{/ZAutomation/api/v1/system/first-access}
...
The administrator password can be set by sending the new password in JSON format using PUT to URL \murl{/ZAutomation/api/v1/auth/update/1}
...
You should see a POST request with data in the log: \murl{http://192.168.1.39:8083/ZAutomation/api/v1/instances}
