...
distribution from \murl{https://razberry.zwave.me/z-way-server}.
...
\begin{quote}
\cmdline{LD\_LIBRARY\_PATH=./libs ./zwayserver}
\end{quote}
...
\item Using a standard web browser but the redirection service \murl{find.zwave.me} The 
...
\textbf{Please remember this \zwaydeviceid!}
...
a native app for the mobile phone. Open the url \murl{http://find.z-wave.me/}
...
URL \murl{http://find.z-wave.me/zboxweb}.
