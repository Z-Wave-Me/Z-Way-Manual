...
The \zway library is a middleware between Sigma Designs \zwave transceiver and your application. 
...
\item Sending commands
\end{itemize}

Every command request generates an outgoing packet (job). Before generating a packet, 
library will validate parameters and check whether the command is supported by recipient. 
...
\zwave stack, and then confirmed it was delivered to recipient. All these operations are 
...
All incoming packets from \zwave network are automatically parsed by \zway and stored in 
