...
\begin{quote}C Syntax: ZWError zway\_fc\_send\_data(ZWay zway, ZWNODE node\_id, const ZWBYTE * data, ZWCSTR description, ZJobCustomCallback successCallback, ZJobCustomCallback failureCallback, void* callbackArg)\end{quote}
...
\begin{quote}C Syntax: ZWError zway\_fc\_send\_data\_secure(ZWay zway, ZWNODE node\_id, const ZWBYTE * data, ZWCSTR description, ZWBYTE key\_class, ZJobCustomCallback successCallback, ZJobCustomCallback failureCallback, void* callbackArg)\end{quote}
...
\begin{quote}C Syntax: ZWError zway\_fc\_application\_command\_handler\_inject(ZWay zway, ZWNODE node\_id, const ZWBYTE * data, ZJobCustomCallback successCallback, ZJobCustomCallback failureCallback, void* callbackArg)\end{quote}
...
\paragraph{Function Class SetLongRangeChannel}
