...
\begin{quote}C Syntax: ZWError zway\_fc\_zme\_bootloader\_flash(ZWay zway, ZWBYTE addr, ZJobCustomCallback successCallback, ZJobCustomCallback failureCallback, void* callbackArg)\end{quote}
...
\begin{quote}C Syntax: ZWError zway\_fc\_serial\_api\_setup(ZWay zway, ZWBYTE function, ZWBOOL enable, ZJobCustomCallback successCallback, ZJobCustomCallback failureCallback, void* callbackArg)\end{quote}
