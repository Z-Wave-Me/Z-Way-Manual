...
\section{Command Class NodeProvisioning (0x78/120)}

\textit{Version 1, Supported and Controlled}
\newline

Allows to interact with the DSK Provisioning List.
\newline
...
\begin{itemize}
\item \textbf{smartStart.dskProvisioningList}: DSK Provisioning List
\end{itemize}

\paragraph{Command NodeProvisioning Get}
\begin{quote}Syntax: Get(dsk, successCallback = NULL, failureCallback = NULL)\end{quote}
\begin{quote}Description: Send NodeProvisioning Get\end{quote}
\begin{quote}Parameter dsk: DSK value\end{quote}
\begin{quote}Parameter successCallback: Custom function to be called on function success. NULL if callback is not needed\end{quote}
\begin{quote}Parameter failureCallback: Custom function to be called on function failure. NULL if callback is not needed\end{quote}


\paragraph{Command NodeProvisioning Set}
\begin{quote}Syntax: Set(dsk, successCallback = NULL, failureCallback = NULL)\end{quote}
\begin{quote}Description: Send NodeProvisioning Set\end{quote}
\begin{quote}Parameter dsk: DSK value\end{quote}
\begin{quote}Parameter successCallback: Custom function to be called on function success. NULL if callback is not needed\end{quote}
\begin{quote}Parameter failureCallback: Custom function to be called on function failure. NULL if callback is not needed\end{quote}


\paragraph{Command NodeProvisioning Delete}
\begin{quote}Syntax: Delete(dsk, successCallback = NULL, failureCallback = NULL)\end{quote}
\begin{quote}Description: Send NodeProvisioning Delete\end{quote}
\begin{quote}Parameter dsk: DSK value\end{quote}
\begin{quote}Parameter successCallback: Custom function to be called on function success. NULL if callback is not needed\end{quote}
\begin{quote}Parameter failureCallback: Custom function to be called on function failure. NULL if callback is not needed\end{quote}


\paragraph{Command NodeProvisioning IterationGet}
\begin{quote}Syntax: IterationGet(successCallback = NULL, failureCallback = NULL)\end{quote}
\begin{quote}Description: Send NodeProvisioning Iteration Get\end{quote}
\begin{quote}Parameter successCallback: Custom function to be called on function success. NULL if callback is not needed\end{quote}
\begin{quote}Parameter failureCallback: Custom function to be called on function failure. NULL if callback is not needed\end{quote}
