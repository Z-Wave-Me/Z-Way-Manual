...
\item \qquad\textbf{hasCode}: Flag if a valid code is set (in case device reports occupied, but code is not valid (less than 4 symbols)
\end{itemize}
...
\item \textbf{device->data->secureChannelEstablished}: Flag describing is security interview was successful and secure channel is established (this data is on device data tree)
...
\section{Command Class Schedule (0x53/83)}

Allows to exchange schedules which specify when to set a new behaviour. The Schedule Command Class is a generic scheduling Command Class that can be used to make schedules for any device type.
\newline
...
\begin{itemize}
\item \textbf{[slotId]}: ...
\item \qquad\textbf{day}: ...
\item \qquad\textbf{month}: ...
\item \qquad\textbf{year}: ...
\item \qquad\textbf{weekday}: ...
\item \qquad\textbf{time}: ...
\item \qquad\textbf{duration}: ...
\item \textbf{max}: ...
\item \textbf{supportsDisable}: ...
\item \textbf{supportsFallback}: ...
\item \textbf{supportsOverride}: ...
\item \textbf{supportedStartTime}: ...
\item \textbf{supportedOverrideTypes}: ...
\item \textbf{supportedCommandClasses}: ...
\end{itemize}
